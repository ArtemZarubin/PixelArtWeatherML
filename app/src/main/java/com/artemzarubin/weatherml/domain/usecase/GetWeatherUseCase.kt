 ...
 * @return A [Resource] wrapping the [CurrentWeatherResponseDto] or an error.
...
class GetWeatherUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        lat: Double,
        lon: Double
    ): Resource<CurrentWeatherResponseDto> { // New return type
        ...
        return weatherRepository.getCurrentWeather(lat = lat, lon = lon, apiKey = apiKey)
    }
}